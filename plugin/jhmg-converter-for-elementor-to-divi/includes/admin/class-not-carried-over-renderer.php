...
class NotCarriedOverRenderer {
    ...
    private static function groups(): array {
        return [
            ...
            'social_network' => __( 'Social networks Divi does not offer — dropped', 'jhmg-converter-for-elementor-to-divi' ),
            'query_filter' => __( 'Post query filters Divi\'s blog module cannot express — dropped', 'jhmg-converter-for-elementor-to-divi' ),
