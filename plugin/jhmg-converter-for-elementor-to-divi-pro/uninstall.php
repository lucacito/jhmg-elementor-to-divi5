 ...
 *
 * Kit data (`edc_kit_globals` option + the uploaded kit ZIP) is owned by Pro
 * — Pro's GlobalsStore is what writes it — so its cleanup belongs here, not
 * in the free plugin's uninstall.php.
 */
